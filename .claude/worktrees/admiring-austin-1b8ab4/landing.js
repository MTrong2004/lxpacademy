...
(function () {
  ...
  function createIntro() {
    ...
    logo.innerHTML  = '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center"><img src="Logo.png" alt="Logo" style="width:clamp(48px,8vw,72px);height:clamp(48px,8vw,72px);object-fit:contain;margin-bottom:10px;filter:drop-shadow(0 4px 12px rgba(0,0,0,.15))"><div style="font-weight:950;font-size:clamp(1.35rem,3.2vw,2.2rem);line-height:1;letter-spacing:.16em">HOD</div><div style="margin-top:8px;font-size:clamp(.58rem,1.2vw,.72rem);font-weight:850;letter-spacing:.26em;color:rgba(16,34,51,.55)">LEARNING HUB</div></div>';
